...
log "5️ Esperando que la aplicación esté lista..."
sleep 30

# 6. Obtener IP e iniciar port-forward
LOCAL_IP=$(hostname -I | awk '{print $1}')
log "6️ IP local: $LOCAL_IP"
